...
<head>
    ...
    <!-- Meta SEO -->
    <meta name="title" content="Medi-K">
    <meta name="description" content="Medi · k es una TPA (Third Party Administrator), empresa proveedora de servicios de gestión y control en procesos médicos.">
    <meta name="robots" content="index, follow">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="language" content="English">
    <meta name="author" content="Medi-K">

    <!-- Social media share -->
    <meta property="og:title" content="Medi-K">
    <meta property="og:site_name" content="Medi-K">
    <meta property="og:url" content="https://medi-k.com.pe/welcome">
    <meta property="og:description" content="Medi · k es una TPA (Third Party Administrator), empresa proveedora de servicios de gestión y control en procesos médicos.">
    <meta property="og:type" content="">
    <meta property="og:image" content="Medi-K">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="./images/logoico.ico">
...
<body>
        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" class="flex items-center">
                    <img src="./images/logo.png" class="h-9 mr-3 sm:h-16" alt="Landwind Logo" />
                </a>
                <div class="flex items-center lg:order-2">
                    <a href="https://medi-k.com.pe/login" class="text-white focus:ring-4 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none hover:bg-blue-600" style="background-color: #5075B9;">Login</a>
                ...
                <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-white bg-blue-600 rounded lg:bg-transparent lg:text-blue-600 lg:p-0 dark:text-white font-bold" aria-current="page">Política</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Económico</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Empresariales</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Pacientes</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Auditoría</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Ramas</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Mapa</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Áreas</a>
                        </li>
                        <li>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-6">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">¿Qué somos?</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"><label class=" font-bold">Medi</label><label class="text-red-600 font-bold">·</label><label class="font-bold">k</label> es una TPA (Third Party Administrator), empresa proveedora de servicios de gestión y control en procesos médicos.</p>
                <div class="space-y-4  hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img id="iso27001" src="./images/ISO-IEC-27001.png" class="h-9 mr-3 sm:h-16 inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"" alt="Landwind Logo" />
                </div>
            </div>
            <div class="hidden lg:mt-0 lg:col-span-6 lg:flex">
                <img src="./images/cerdito.png" alt="hero image">
            </div>
        </div>
    </section>
    <!-- End block -->
    ...
    <section class="bg-white dark:bg-white">
        <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
            <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Grupo Económico</h2>
        </div>
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
            <div class="grid grid-cols-2 gap-8 sm:gap-12 sm:grid-cols-3 lg:grid-cols-6 text-gray-500 dark:text-gray-400">
                <!-- Empresa 1 -->
                <a href="#" class="flex items-center justify-center">
                    <img class="h-14 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white" src="./images/acme.png" alt="ACME Logo">
                </a>
                <!-- Empresa 2 -->
                <a href="#" class="flex items-center justify-center">
                    <img class="h-14 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white" src="./images/medi-k.png" alt="Medi-K Logo">
                </a>
                <!-- Empresa 3 -->
                <a href="#" class="flex items-center justify-center">
                    <img class="h-14 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white" src="./images/acmetic.png" alt="Acmetic Logo">
                </a>
                <!-- Empresa 4 -->
                <a href="#" class="flex items-center justify-center">
                    <img class="h-14 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white" src="./images/drc.png" alt="DRC Logo">
                </a>
                <!-- Empresa 5 -->
                <a href="#" class="flex items-center justify-center">
                    <img class="h-14 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white" src="./images/pyclogo.png" alt="PYC Logo">
                </a>
                <!-- Empresa 6 -->
                <a href="#" class="flex items-center justify-center">
                    <img class="h-14 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white" src="./images/future.png" alt="Future Logo">
                </a>
                <!-- Empresa 7 -->
                <a href="#" class="flex items-center justify-center">
                    <img class="h-14 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white" src="./images/sga.png" alt="SGA Logo">
                </a>
                <!-- Empresa 8 -->
                <a href="#" class="flex items-center justify-center">
                    <img class="h-14 transition-colors duration-300 hover:text-gray-900 dark:hover:text-white" src="./images/sdg.png" alt="SDG Logo">
                </a>
            </div>
        </div>
    </section>
